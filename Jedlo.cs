...
namespace szakdolgozat
{
    ...
    {
        private IMongoCollection<Termekek> jedloTabla = Program.termekAdatbazis.GetCollection<Termekek>("jedlo");

        private DataGridView dataJedloB;
        ...
        private void TextboxKod_TextChanged(object? sender, EventArgs e)
        {
            ...
            var termek = jedloTabla.Find(filterDefinition).FirstOrDefault();
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            jedloTabla.UpdateOne(filterDefinition, updateDefinition);
            refreshDataGrid();
        }
        ...
        private void InitializeComponentB()
        {
            ...
            {
                Text = $"Spolu jedlo: {celkomjedlo.ToString("N2")}",
        ...
        private void buttonNewB_Click(object sender, EventArgs e)
        {
            ...
            jedloTabla.InsertOne(newTermek);
            refreshDataGrid();
        }
        ...
        {
            var filterDefinition = Builders<Termekek>.Filter.Eq(a => a.ProductCode, textboxKodB.Text);
            jedloTabla.DeleteOne(filterDefinition);
        ...
        private void refreshDataGrid()
        {
            ...
            var term = jedloTabla.Find(filterDefinition).ToList();
            ...
            if(_isAdmin)
            {
                labelCelkomB.Text = $"Spolu jedlo: {celkomjedlo.ToString("N2")} €";
            } 
