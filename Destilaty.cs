...
namespace szakdolgozat
{
    public class Destilaty : Form
    {
        ...
        {
            this.Text = "Destilaty - Pracovník";
            this.Size = new System.Drawing.Size(1100, 450);
            this.FormBorderStyle = FormBorderStyle.FixedSingle;
            this.MaximizeBox = false;

            dataDestilatyB = new DataGridView
            {
            ...
            this.Controls.Add(dataDestilatyB);
        ...
        private void TextboxKod_TextChanged(object? sender, EventArgs e)
        {
            ...
            var termek = destilatyTabla.Find(filterDefinition).FirstOrDefault();
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            destilatyTabla.UpdateOne(filterDefinition, updateDefinition);
            refreshDataGrid();
        }
        ...
        private void InitializeComponentB()
        {
            ...
            {
                Text = $"Spolu destilaty: {celkomdestilaty.ToString("N2")}",
        ...
        private void buttonNewB_Click(object sender, EventArgs e)
        {
            ...
            destilatyTabla.InsertOne(newTermek);
            refreshDataGrid();
        }
        ...
        {
            var filterDefinition = Builders<Termekek>.Filter.Eq(a => a.ProductCode, textboxKodB.Text);
            destilatyTabla.DeleteOne(filterDefinition);
        ...
        private void refreshDataGrid()
        {
            ...
            var term = destilatyTabla.Find(filterDefinition).ToList();
            ...
            foreach (var termek in term)
            {
                ...
                decimal destilaty = (((termek.ZosPred + termek.Prijem) - termek.UzavZos) * termek.Price);

                if (_isAdmin)
                {
                    row["Spolu"] = destilaty.ToString();
                };

                celkomdestilaty += destilaty;
            ...
            if (_isAdmin)
            {
                labelCelkomB.Text = $"Spolu destilaty: {celkomdestilaty.ToString("N2")} €";
            }

            dataDestilatyB.DataSource = dataTable;
        }
