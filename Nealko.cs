...
{
    public class Nealko : Form
    {
        private IMongoCollection<Termekek> nealkoTabla = Program.termekAdatbazis.GetCollection<Termekek>("nealko");

        private DataGridView dataNealkoB;
        ...
        private void TextboxKod_TextChanged(object? sender, EventArgs e)
        {
            ...
            var termek = nealkoTabla.Find(filterDefinition).FirstOrDefault();
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            nealkoTabla.UpdateOne(filterDefinition, updateDefinition);
            refreshDataGrid();
        }
        ...
        {
            var filterDefinition = Builders<Termekek>.Filter.Eq(a => a.ProductCode, textboxKodB.Text);
            nealkoTabla.DeleteOne(filterDefinition);
        ...
        private void refreshDataGrid()
        {
            ...
            var term = nealkoTabla.Find(filterDefinition).ToList();
            ...
            if (_isAdmin)
            {
                labelCelkomB.Text = $"Spolu nealko: {celkomnealko.ToString("N2")} €";
            }
